...
// <-- Changes for anchor reload -->


document.addEventListener('DOMContentLoaded', function() {
  
  // Fix scrolling when arriving at #testimonial
  ...
  // Fix menu links to testimonials
  document.querySelectorAll('a[href*="#testimonial"]').forEach(function(link) {
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.querySelectorAll('a[href*="#howitworks"]').forEach(function(link) {
    link.addEventListener('click', function() {
      setTimeout(function() {
        document.body.style.overflow = 'auto';
        document.body.classList.remove('overflow-hidden', 'no-scroll');
